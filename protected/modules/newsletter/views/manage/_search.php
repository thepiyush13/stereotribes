...
$form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php // echo $form->textAreaRow($model,'text_body',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>

	<?php // echo $form->textFieldRow($model,'misc',array('class'=>'span5','maxlength'=>20)); ?>
...
?>	
   <script>
	$(".btnreset").click(function(){
		$(":input","#search-newsletter-form").each(function() {
		var type = this.type;
