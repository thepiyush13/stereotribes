...
<!--<script  type="text/javascript" src="<?php // echo Yii::app()->request->baseUrl; ?>/adassets/pages-assets/js/tinymce.js"></script>-->
...
tinymce.init({
 ...
 <!--<textarea rows="6" cols="50" name="Pages[url]" id="Pages_url"></textarea>-->
<!--<div class="row">
    <h1>Editor</h1>
    <form method="post">
    <textarea></textarea>
		...
		*/
		      ...
		      'type'=>'raw',
		       ...
		       'value'=>'"
                      ...
                      <a href=\"'.Yii::app()->createUrl("/pages/").'/$data->id\"  class=\'btn btn-small view news-icon\'  ><i class=\'icon-eye-open\'></i></a>
...
<script type="text/javascript"> 
  ...
  $(document).ready(function(){
        ...
        $('#pages-create-modal').on('shown', function() {
...
function delete_record(id)
{
 ...
 var data="id="+id;
  ...
  jQuery.ajax({
   type: 'POST',
    url: '<?php echo Yii::app()->createAbsoluteUrl("/pages/manage/delete"); ?>',
   data:data,
...
<?php  
  ...
  $cs->registerScriptFile($baseUrl.'/adassets/pages-assets/js/tinymce.js');
